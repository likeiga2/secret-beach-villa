...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', backgroundImage: "url('/washi_gold.jpg')", backgroundSize: 'cover', backgroundRepeat: 'repeat', minHeight: '100vh' }}>
      {/* ヒーローカード */}
      <section
        style={{
          maxWidth: '90%',
      ...
      {/* 施設紹介 */}
      <section id="about" style={{ padding: '3rem 1rem', maxWidth: '800px', margin: '0 auto', color: '#333' }}>
      ...
      {/* 予約セクション */}
      <section id="booking" style={{ padding: '3rem 1rem', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
      ...
      {/* お問い合わせセクション */}
      <section id="contact" style={{ padding: '3rem 1rem', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem' }}>お問い合わせ</h2>
        <p style={{ marginBottom: '1rem' }}>ご質問がある方はお気軽にご連絡ください。</p>
      </section>

      <footer
        style={{ textAlign: 'center', padding: '1rem 0', backgroundColor: 'rgba(0,0,0,0.8)', color: '#fff' }}
      >
